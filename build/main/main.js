...
const productionUrl = path__WEBPACK_IMPORTED_MODULE_2___default().resolve(__dirname, "../renderer/index.html");
const appUrl = (electron_is_dev__WEBPACK_IMPORTED_MODULE_1___default())
    ? "http://localhost:3000"
    : url__WEBPACK_IMPORTED_MODULE_3___default().format({
...
electron__WEBPACK_IMPORTED_MODULE_0__.app.whenReady().then(run);
